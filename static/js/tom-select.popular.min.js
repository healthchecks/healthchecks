...
const l=i(o)
return u=new RegExp("^"+l,"u"),s},w=(t,e=1)=>(e=Math.max(e,t.length-1),i(c(t).map(t=>((t,e=1)=>{let i=0
...
constructor(){this.parts=[],this.substrs=[],this.start=0,this.end=0}add(t){t&&(this.parts.push(t),this.substrs.push(t.substr),this.start=Math.min(t.start,this.start),this.end=Math.max(t.end,this.end))}last(){return this.parts[this.parts.length-1]}length(){return this.parts.length}clone(t,e){let i=new I,s=JSON.parse(JSON.stringify(this.parts)),n=s.pop()
for(const t of s)i.add(t)
let o=e.substr.substring(0,t-n.start),r=o.length
return i.add({start:n.start,end:n.start+r,length:r,substr:o}),i}}const A=t=>{void 0===p&&(p=b(d)),t=v(t)
let e="",i=[new I]
for(let s=0;s<t.length;s++){let n=t.substring(s).match(u)
...
let t=new I
const s=i[0]
s&&t.add(s.last()),i=[t]}}return e+=S(i,!0),e},C=(t,e)=>{if(t)return t[e]},x=(t,e)=>{if(t){for(var i,s=e.split(".");(i=s.shift())&&(t=t[i]););return t}},F=(t,e,i)=>{var s,n
...
function lt(t,e){var i=Object.assign({},rt,e),s=i.dataAttr,n=i.labelField,o=i.valueField,r=i.disabledField,l=i.optgroupField,a=i.optgroupLabelField,c=i.optgroupValueField,d=t.tagName.toLowerCase(),p=t.getAttribute("placeholder")||t.getAttribute("data-placeholder")
if(!p&&!i.allowEmptyOption){let e=t.querySelector('option[value=""]')
e&&(p=e.textContent)}var u={placeholder:p,options:[],optgroups:[],items:[],maxItems:null}
return"select"===d?(()=>{var e,d=u.options,p={},h=1
let g=0
...
if(null!=s&&(s||i.allowEmptyOption)){if(p.hasOwnProperty(s)){if(e){var a=p[s][l]
a?Array.isArray(a)?a.push(e):p[s][l]=[a,e]:p[s][l]=e}}else{var c=f(t)
c[n]=c[n]||t.textContent,c[o]=c[o]||s,c[r]=c[r]||t.disabled,c[l]=c[l]||e,c.$option=t,c.$order=c.$order||++g,p[s]=c,d.push(c)}t.selected&&u.items.push(s)}}
u.maxItems=t.hasAttribute("multiple")?null:1,B(t.children,t=>{var i,s,n
"optgroup"===(e=t.tagName.toLowerCase())?((n=f(i=t))[a]=n[a]||i.getAttribute("label")||"",n[c]=n[c]||h++,n[r]=n[r]||i.disabled,n.$order=n.$order||++g,u.optgroups.push(n),s=n[c],B(i.children,t=>{m(t,s)})):"option"===e&&m(t)})})():(()=>{const e=t.getAttribute(s)
if(e)u.options=JSON.parse(e),B(u.options,t=>{u.items.push(t[o])})
...
B(e,t=>{const e={}
e[n]=t,e[o]=t,u.options.push(e)}),u.items=e}})(),Object.assign({},rt,u,e)}var at=0
...
const r=K("<div>"),l=K("<div>"),a=this._render("dropdown"),c=K('<div role="listbox" tabindex="-1">'),d=this.input.getAttribute("class")||"",p=n.mode
var u
if(J(r,n.wrapperClass,d,p),J(l,n.controlClass),z(r,l),J(a,n.dropdownClass,p),n.copyClassesToDropdown&&J(a,d),J(c,n.dropdownContentClass),z(a,c),K(n.dropdownParent||r).appendChild(a),G(n.controlInput)){u=K(n.controlInput)
B(["autocorrect","autocapitalize","autocomplete","spellcheck","aria-label"],t=>{s.getAttribute(t)&&it(u,{[t]:s.getAttribute(t)})}),u.tabIndex=-1,l.appendChild(u),this.focus_node=u}else n.controlInput?(u=K(n.controlInput),this.focus_node=u):(u=K("<input/>"),this.focus_node=l)
this.wrapper=r,this.dropdown=a,this.dropdown_content=c,this.control=l,this.control_input=u,this.setup()}setup(){const t=this,e=t.settings,i=t.control_input,s=t.dropdown,n=t.dropdown_content,o=t.wrapper,l=t.control,a=t.input,c=t.focus_node,d={passive:!0},p=t.inputId+"-ts-dropdown"
it(n,{id:p}),it(c,{role:"combobox","aria-haspopup":"listbox","aria-expanded":"false","aria-controls":p})
const u=H(c,t.inputId+"-ts-control"),h="label[for='"+(t=>t.replace(/['"\\]/g,"\\$&"))(t.inputId)+"']",g=document.querySelector(h),f=t.focus.bind(t)
if(g){R(g,"click",f),it(g,{for:u})
...
const b=(t,e)=>{let i=p[t]
if(void 0!==i){let t=u[i]
if(void 0!==t)return[i,t.fragment]}let s=document.createDocumentFragment()
return i=u.length,u.push({fragment:s,order:e,optgroup:t}),[i,s]}
...
const[s,a]=b(o,t)
i>0&&(d=d.cloneNode(!0),it(d,{id:l.$id+"-clone-"+i,"aria-selected":null}),d.classList.add("ts-cloned"),U(d,"active"),h.activeOption&&h.activeOption.dataset.value==n&&c&&c.dataset.group===o.toString()&&(v=d)),a.appendChild(d),""!=o&&(p[o]=s)}}var S
h.settings.lockOptgroupOrder&&u.sort((t,e)=>t.order-e.order),l=document.createDocumentFragment(),B(u,t=>{let e=t.fragment,i=t.optgroup
...
if(h.loading?_("loading"):h.settings.shouldLoad.call(h,g)?0===m.items.length&&_("no_results"):_("not_loading"),(a=h.canCreate(g))&&(d=_("option_create")),h.hasOptions=m.items.length>0||a,y){if(m.items.length>0){if(v||"single"!==h.settings.mode||null==h.items[0]||(v=h.getOption(h.items[0])),!O.contains(v)){let t=0
...
if(i){const s=et(i)
t.setCaret(e>0?s+1:s),t.setActiveItem(),U(i,"last-active")}else t.setCaret(t.caretPos+e)})}),ct.define("dropdown_input",function(){const t=this
t.settings.shouldOpen=!0,t.hook("before","setup",()=>{var e
t.focus_node=t.control,J(t.control_input,"dropdown-input")
const i=K('<div class="dropdown-input-wrap">')
i.append(t.control_input),t.dropdown.insertBefore(i,t.dropdown.firstChild)
const s=K('<input class="items-placeholder" tabindex="-1" />')
s.placeholder=t.settings.placeholder||"",t.control.append(s)
const n=null==(e=t.input)?void 0:e.getAttribute("aria-label")
n&&s.setAttribute("aria-label",n)}),t.on("initialize",()=>{t.control_input.addEventListener("keydown",e=>{switch(e.keyCode){case 27:return t.isOpen&&(q(e,!0),t.close()),void t.clearActiveItems()
...
var i=this
if(e.append){var s='<a href="javascript:void(0)" class="'+e.className+'" tabindex="-1" title="'+V(e.title)+'">'+e.label+"</a>"
i.hook("after","setupTemplates",()=>{var t=i.settings.render.item
i.settings.render.item=(e,n)=>{var o=K(t.call(i,e,n)),r=K(s)
return o.appendChild(r),R(r,"mousedown",t=>{q(t,!0)}),R(r,"click",t=>{i.isLocked||(q(t,!0),i.isLocked||i.shouldDelete([o],t)&&(i.removeItem(o),i.refreshOptions(!1),i.inputState()))}),o}})}}),ct.define("restore_on_backspace",function(t){const e=this,i=Object.assign({text:t=>t[e.settings.labelField]},t)
