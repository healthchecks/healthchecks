...
class ProfileTestCase(BaseTestCase):
    ...
    def test_it_shows_no_warning_if_multiple_keys_are_registered(self):
        Credential.objects.create(user=self.alice, name="Alices Key")
    ...
    def test_it_shows_no_warning_if_key_and_totp_is_registered(self):
        Credential.objects.create(user=self.alice, name="Alices Key")
        self.profile.totp = "0" * 32
        self.profile.totp_created = "2020-01-01T00:00:00+00:00"
        self.profile.save()
    ...
    @override_settings(RP_ID=None)
    def test_it_does_not_mention_security_key_if_rp_id_is_not_set(self):
        self.profile.totp = "0" * 32
        self.profile.totp_created = "2020-01-01T00:00:00+00:00"
        self.profile.save()
