...
<li><a href="#SHOW_FOOTER">SHOW_FOOTER</a></li>
...
A boolean that turns on/off the footer.

The "SHOW_FOOTER" display the footer.
This integration is enabled by default and can be disable by setting
the `SHOW_FOOTER` environment variable to `False`.
